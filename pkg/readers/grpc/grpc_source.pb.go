...
type PostMessageRequest struct {
	...
	SourceId             string   `protobuf:"bytes,2,opt,name=source_id,json=sourceId" json:"source_id,omitempty", bson:"source_id,omitempty"`
	RequestId            string   `protobuf:"bytes,3,opt,name=request_id,json=requestId" json:"request_id,omitempty", bson:"request_id,omitempty"`
...
func (*PostMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_source_50c95f04aa5e10e6, []int{0}
}
...
func (*PostMessageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_source_50c95f04aa5e10e6, []int{1}
}
...
func (c *readerClient) PostMessage(ctx context.Context, in *PostMessageRequest, opts ...grpc.CallOption) (*PostMessageResponse, error) {
	out := new(PostMessageResponse)
	err := c.cc.Invoke(ctx, "/grpc.Reader/PostMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reader_PostMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReaderServer).PostMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Reader/PostMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReaderServer).PostMessage(ctx, req.(*PostMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Reader_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.Reader",
	HandlerType: (*ReaderServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PostMessage",
			Handler:    _Reader_PostMessage_Handler,
		},
	},
...
func init() { proto.RegisterFile("grpc_source.proto", fileDescriptor_grpc_source_50c95f04aa5e10e6) }

var fileDescriptor_grpc_source_50c95f04aa5e10e6 = []byte{
	...
	0xc8, 0x8f, 0x8b, 0x2d, 0x28, 0x35, 0x31, 0x25, 0xb5, 0x48, 0xc8, 0x85, 0x8b, 0x1b, 0x49, 0x81,
	0x90, 0x84, 0x1e, 0xc8, 0xf1, 0x7a, 0x98, 0x0e, 0x97, 0x92, 0xc4, 0x22, 0x03, 0x31, 0x4d, 0x89,
	0x21, 0x89, 0x0d, 0xec, 0x73, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2a, 0x81, 0xea, 0x7a,
	0x0e, 0x01, 0x00, 0x00,
}
