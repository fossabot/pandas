...
func (pf *deviceMetricsFactory) initialize(factoryServingOptions *FactoryServingOptions) error {
	modelDB, err := gorm.Open(factoryServingOptions.StorePath, "pandas-device-metrics.db")
	if err != nil {
		return err
	}
