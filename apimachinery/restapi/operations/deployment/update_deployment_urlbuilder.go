...
func (o *UpdateDeploymentURL) Build() (*url.URL, error) {
	...
	if deploymentID != "" {
		...
		return nil, errors.New("deploymentId is required on UpdateDeploymentURL")
	}
...
func (o *UpdateDeploymentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateDeploymentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateDeploymentURL")
	}
