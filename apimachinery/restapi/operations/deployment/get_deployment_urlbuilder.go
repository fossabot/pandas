...
func (o *GetDeploymentURL) Build() (*url.URL, error) {
	...
	if deploymentID != "" {
		...
		return nil, errors.New("deploymentId is required on GetDeploymentURL")
	}
...
func (o *GetDeploymentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDeploymentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDeploymentURL")
	}
