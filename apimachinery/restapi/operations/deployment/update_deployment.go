...
func (fn UpdateDeploymentHandlerFunc) Handle(params UpdateDeploymentParams, principal *models.Principal) middleware.Responder {
...
func NewUpdateDeployment(ctx *middleware.Context, handler UpdateDeploymentHandler) *UpdateDeployment {
	return &UpdateDeployment{Context: ctx, Handler: handler}
}
...
func (o *UpdateDeployment) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewUpdateDeploymentParams()
