...
func (o *SetDeploymentStatusURL) WithBasePath(bp string) *SetDeploymentStatusURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *SetDeploymentStatusURL) Build() (*url.URL, error) {
	...
	var _path = "/deployments/{deploymentId}"

	deploymentID := o.DeploymentID
	if deploymentID != "" {
		_path = strings.Replace(_path, "{deploymentId}", deploymentID, -1)
	} else {
		return nil, errors.New("deploymentId is required on SetDeploymentStatusURL")
	}
...
func (o *SetDeploymentStatusURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SetDeploymentStatusURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SetDeploymentStatusURL")
	}
