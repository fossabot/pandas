...
func (o *SaveRuleChainURL) Build() (*url.URL, error) {
	...
	if ruleChainID != "" {
		...
		return nil, errors.New("ruleChainId is required on SaveRuleChainURL")
	}
...
func (o *SaveRuleChainURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SaveRuleChainURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SaveRuleChainURL")
	}
