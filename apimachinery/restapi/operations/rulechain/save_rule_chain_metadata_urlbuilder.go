...
func (o *SaveRuleChainMetadataURL) WithBasePath(bp string) *SaveRuleChainMetadataURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *SaveRuleChainMetadataURL) Build() (*url.URL, error) {
	...
	var _path = "/rulechains/{ruleChainId}/metadata"

	ruleChainID := o.RuleChainID
	if ruleChainID != "" {
		_path = strings.Replace(_path, "{ruleChainId}", ruleChainID, -1)
	} else {
		return nil, errors.New("ruleChainId is required on SaveRuleChainMetadataURL")
	}
...
func (o *SaveRuleChainMetadataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SaveRuleChainMetadataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SaveRuleChainMetadataURL")
	}
