...
func (fn UploadRuleChainHandlerFunc) Handle(params UploadRuleChainParams, principal *models.Principal) middleware.Responder {
...
func NewUploadRuleChain(ctx *middleware.Context, handler UploadRuleChainHandler) *UploadRuleChain {
	return &UploadRuleChain{Context: ctx, Handler: handler}
}
...
func (o *UploadRuleChain) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewUploadRuleChainParams()
