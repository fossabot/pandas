...
func (fn SaveRuleChainMetadataHandlerFunc) Handle(params SaveRuleChainMetadataParams, principal *models.Principal) middleware.Responder {
...
func NewSaveRuleChainMetadata(ctx *middleware.Context, handler SaveRuleChainMetadataHandler) *SaveRuleChainMetadata {
	return &SaveRuleChainMetadata{Context: ctx, Handler: handler}
}
...
func (o *SaveRuleChainMetadata) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewSaveRuleChainMetadataParams()
