...
// SaveRuleChainMetadataParams contains all the bound params for the save rule chain metadata operation
...
func (o *SaveRuleChainMetadataParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SaveRuleChainMetadataParams) bindRuleChainID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
