...
// GetRuleChainParams contains all the bound params for the get rule chain operation
...
func (o *GetRuleChainParams) bindRuleChainID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
