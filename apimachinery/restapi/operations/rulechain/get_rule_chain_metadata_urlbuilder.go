...
func (o *GetRuleChainMetadataURL) WithBasePath(bp string) *GetRuleChainMetadataURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRuleChainMetadataURL) Build() (*url.URL, error) {
	...
	if ruleChainID != "" {
		...
		return nil, errors.New("ruleChainId is required on GetRuleChainMetadataURL")
	}
...
func (o *GetRuleChainMetadataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRuleChainMetadataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRuleChainMetadataURL")
	}
