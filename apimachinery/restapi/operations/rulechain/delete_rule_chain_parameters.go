...
// DeleteRuleChainParams contains all the bound params for the delete rule chain operation
...
func (o *DeleteRuleChainParams) bindRuleChainID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
