...
func (o *ChangeCurrentUserPasswordURL) WithBasePath(bp string) *ChangeCurrentUserPasswordURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ChangeCurrentUserPasswordURL) String() string {
...
func (o *ChangeCurrentUserPasswordURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ChangeCurrentUserPasswordURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ChangeCurrentUserPasswordURL")
	}
