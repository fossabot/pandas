...
func (o *GetModelURL) Build() (*url.URL, error) {
	...
	if modelID != "" {
		...
		return nil, errors.New("modelId is required on GetModelURL")
	}
...
func (o *GetModelURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetModelURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetModelURL")
	}
