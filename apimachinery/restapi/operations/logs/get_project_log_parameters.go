...
// GetProjectLogParams contains all the bound params for the get project log operation
...
func (o *GetProjectLogParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
