...
func (o *AddProjectDeviceURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on AddProjectDeviceURL")
	}
...
func (o *AddProjectDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AddProjectDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AddProjectDeviceURL")
	}
