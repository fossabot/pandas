...
func (o *UpdateProjectDeviceStatusURL) WithBasePath(bp string) *UpdateProjectDeviceStatusURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateProjectDeviceStatusURL) Build() (*url.URL, error) {
	...
	var _path = "/project/{projectId}/devices/{deviceId}"

	deviceID := o.DeviceID
	if deviceID != "" {
		_path = strings.Replace(_path, "{deviceId}", deviceID, -1)
	} else {
		return nil, errors.New("deviceId is required on UpdateProjectDeviceStatusURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on UpdateProjectDeviceStatusURL")
	}
...
func (o *UpdateProjectDeviceStatusURL) String() string {
...
func (o *UpdateProjectDeviceStatusURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateProjectDeviceStatusURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateProjectDeviceStatusURL")
	}
