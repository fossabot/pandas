...
func (o *GetProjectDevicesURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{projectId}/devices"

	projectID := o.ProjectID
	if projectID != "" {
		_path = strings.Replace(_path, "{projectId}", projectID, -1)
	} else {
		return nil, errors.New("projectId is required on GetProjectDevicesURL")
	}
...
func (o *GetProjectDevicesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectDevicesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectDevicesURL")
	}
