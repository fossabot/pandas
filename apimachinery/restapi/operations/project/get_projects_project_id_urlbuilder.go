...
func (o *GetProjectsProjectIDURL) WithBasePath(bp string) *GetProjectsProjectIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetProjectsProjectIDURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on GetProjectsProjectIDURL")
	}
...
func (o *GetProjectsProjectIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectsProjectIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectsProjectIDURL")
	}
