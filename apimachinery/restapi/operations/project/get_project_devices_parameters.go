...
// GetProjectDevicesParams contains all the bound params for the get project devices operation
...
func (o *GetProjectDevicesParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
