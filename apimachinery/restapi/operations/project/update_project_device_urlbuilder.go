...
func (o *UpdateProjectDeviceURL) WithBasePath(bp string) *UpdateProjectDeviceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateProjectDeviceURL) Build() (*url.URL, error) {
	...
	if deviceID != "" {
		...
		return nil, errors.New("deviceId is required on UpdateProjectDeviceURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on UpdateProjectDeviceURL")
	}
...
func (o *UpdateProjectDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateProjectDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateProjectDeviceURL")
	}
