...
// GetProjectsProjectIDParams contains all the bound params for the get projects project ID operation
...
func (o *GetProjectsProjectIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetProjectsProjectIDParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
