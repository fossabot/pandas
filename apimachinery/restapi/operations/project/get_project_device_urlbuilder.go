...
func (o *GetProjectDeviceURL) Build() (*url.URL, error) {
	...
	if deviceID != "" {
		...
		return nil, errors.New("deviceId is required on GetProjectDeviceURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on GetProjectDeviceURL")
	}
...
func (o *GetProjectDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectDeviceURL")
	}
