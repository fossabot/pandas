...
func (o *DeleteProjectDeviceURL) WithBasePath(bp string) *DeleteProjectDeviceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteProjectDeviceURL) Build() (*url.URL, error) {
	...
	if deviceID != "" {
		...
		return nil, errors.New("deviceId is required on DeleteProjectDeviceURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on DeleteProjectDeviceURL")
	}
...
func (o *DeleteProjectDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProjectDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProjectDeviceURL")
	}
