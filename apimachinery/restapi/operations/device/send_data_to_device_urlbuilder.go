...
func (o *SendDataToDeviceURL) Build() (*url.URL, error) {
	...
	if deviceID != "" {
		...
		return nil, errors.New("deviceId is required on SendDataToDeviceURL")
	}
...
func (o *SendDataToDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SendDataToDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SendDataToDeviceURL")
	}
